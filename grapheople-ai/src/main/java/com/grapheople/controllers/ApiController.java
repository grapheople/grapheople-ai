...
public class ApiController {
    ...
    public ResponseEntity<?> askQuestion(@RequestParam String question) {
        return processQuestion(question, DEFAULT_USER_ID);
    }
    ...
    public ResponseEntity<?> askQuestionWithUser(
        ...
        return processQuestion(question, userId);
    }
    ...
    public ResponseEntity<?> askQuestionPost(@RequestBody QuestionRequest request) {
        ...
        return processQuestion(request.getQuestion(), userId);
    }

    private ResponseEntity<?> processQuestion(String question, String userId) {
        Session session = null;
        try {
            // 매번 새로운 세션 생성 (세션 재사용 문제 해결)
    ...
    public ResponseEntity<?> testAgent() {
        ...
        return processQuestion(testQuestion, "test_user_" + System.currentTimeMillis());
    }
